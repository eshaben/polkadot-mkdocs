...
- reference
word_count: 92394
token_estimate: 163013
page_count: 63
build_timestamp: '2026-04-16T19:42:11.755721+00:00'
version_hash: sha256:2ae412575f46805797efb9a33e406cecb67c2cb02103c61531a82a1a94d36fdd
---
...
- Resolved Markdown: https://docs.polkadot.com/parachains/customize-runtime/add-existing-pallets.md
...
- Word Count: 1564; Token Estimate: 2662
- Last Updated: 2026-04-15T03:51:44+00:00
- Version Hash: sha256:47fecfbf96b7ae4fbbb858faf184a6028b3e189eaadbf4e2088f7e1001a80e53
...
- [Polkadot SDK dependencies installed](/polkadot-mkdocs/parachains/install-polkadot-sdk/)
- A working [Polkadot SDK development environment](/polkadot-mkdocs/parachains/launch-a-parachain/set-up-the-parachain-template/)
...
5. Verify you can see the available extrinsics, such as:
    ...
    ![](/polkadot-mkdocs/images/parachains/customize-runtime/add-existing-pallets/add-pallets-01.webp)
...
-   <span class="badge guide">Guide</span> __Add Multiple Pallet Instances__
    ...
    [:octicons-arrow-right-24: Get Started](/polkadot-mkdocs/parachains/customize-runtime/add-pallet-instances/)
...
- Resolved Markdown: https://docs.polkadot.com/parachains/customize-runtime/add-pallet-instances.md
...
- Word Count: 2166; Token Estimate: 3757
- Last Updated: 2026-04-15T03:51:44+00:00
- Version Hash: sha256:a69718275ba0442e006c66d70b5b1e148dae170fa2ac80da5ed72b2f8c8c836d
...
- A working [Polkadot SDK development environment](/polkadot-mkdocs/parachains/launch-a-parachain/set-up-the-parachain-template/).
- Basic understanding of [adding pallets to a runtime](/polkadot-mkdocs/parachains/customize-runtime/add-existing-pallets/).
...
4. In the **submit the following extrinsic** section, open the pallet dropdown. Verify that both pallet instances appear and contain the expected extrinsics.
    ...
    === "Technical Committee"
        ...
        ![](/polkadot-mkdocs/images/parachains/customize-runtime/add-pallet-instances/add-pallet-instances-01.webp)

    === "Council"

        Select **`council`** and open the extrinsics dropdown.

        ![](/polkadot-mkdocs/images/parachains/customize-runtime/add-pallet-instances/add-pallet-instances-02.webp)
...
2. Query storage for each instance:
    ...
    === "Technical Committee"
        ...
        ![](/polkadot-mkdocs/images/parachains/customize-runtime/add-pallet-instances/add-pallet-instances-03.webp)

    === "Council"

        Select **`council` > `members()`** to view council members.

        ![](/polkadot-mkdocs/images/parachains/customize-runtime/add-pallet-instances/add-pallet-instances-04.webp)
...
-   <span class="badge guide">Guide</span> __Make a Custom Pallet__
    ...
    [:octicons-arrow-right-24: Reference](/polkadot-mkdocs/parachains/customize-runtime/pallet-development/create-a-pallet/)
...
- Resolved Markdown: https://docs.polkadot.com/parachains/customize-runtime/add-smart-contract-functionality.md
...
- Word Count: 795; Token Estimate: 1532
- Last Updated: 2026-04-15T03:51:44+00:00
- Version Hash: sha256:01f2dfc8d1b4fec97770983610f295c4a8ee948447b961208751c72713f874cf
...
- Resolved Markdown: https://docs.polkadot.com/parachains/customize-runtime/pallet-development/benchmark-pallet.md
...
- Word Count: 2404; Token Estimate: 4360
- Last Updated: 2026-04-15T03:51:44+00:00
- Version Hash: sha256:ee2cd8fb55e0e4df54b3f44e955065b0a91590c113407bb84f7f024d5e67a338
...
- Familiarity setting up the Polkadot Omni Node and [Polkadot Chain Spec Builder](https://crates.io/crates/staging-chain-spec-builder). Refer to the [Set Up a Parachain Template](/polkadot-mkdocs/parachains/launch-a-parachain/set-up-the-parachain-template/) guide for instructions if needed.
...
```bash
curl -L https://raw.githubusercontent.com/paritytech/polkadot-sdk/refs/tags/polkadot-stable2512-3/substrate/.maintain/frame-weight-template.hbs \
...
- Resolved Markdown: https://docs.polkadot.com/parachains/runtime-maintenance/coretime-renewal.md
- Canonical (HTML): https://docs.polkadot.com/parachains/runtime-maintenance/coretime-renewal/
...
- Word Count: 2114; Token Estimate: 3425
- Last Updated: 2026-04-15T03:51:44+00:00
- Version Hash: sha256:ff03ea462d27147c193e2ee232405b0dfd1149686e81fc4d9aa92eb96f4e77eb
...
1. In [Polkadot.js Apps](https://polkadot.js.org/apps/#/explorer), connect to the Coretime chain, navigate to the **Developer** dropdown, and select the **Extrinsics** option.
    ...
    ![](/polkadot-mkdocs/images/parachains/runtime-maintenance/coretime-renewal/coretime-renewal-1.webp)
...
2. Submit the `broker.renew` extrinsic:
    ...
    ![](/polkadot-mkdocs/images/parachains/runtime-maintenance/coretime-renewal/coretime-renewal-2.webp)
...
2. For each record, it attempts to process renewal payments from the task's [sovereign account](/polkadot-mkdocs/reference/glossary/#sovereign-account) (which is the sibling account on the Coretime chain derived from the parachain ID).
...
For instructions on establishing this connection, consult the [Opening HRMP Channels with System Parachains](/polkadot-mkdocs/parachains/interoperability/channels-with-system-parachains/) guide.
...
- Calculate it manually:
    ...
    2. Encode your parachain ID as a u32 [SCALE](/polkadot-mkdocs/reference/parachains/data-encoding/#data-types) value:
...
2. Create the `broker.enable_auto_renew` extrinsic:
    ...
    ![](/polkadot-mkdocs/images/parachains/runtime-maintenance/coretime-renewal/coretime-renewal-3.webp)
...
3. Check the transaction weight for executing the call. You can estimate this by executing the `transactionPaymentCallApi.queryCallInfo` runtime call with the encoded call data previously obtained.
    ...
    ![](/polkadot-mkdocs/images/parachains/runtime-maintenance/coretime-renewal/coretime-renewal-4.webp)
...
2. Create a `sudo.sudo` extrinsic that executes `polkadotXcm.send`:
    ...
    ![](/polkadot-mkdocs/images/parachains/runtime-maintenance/coretime-renewal/coretime-renewal-5.webp)
...
3. Construct the XCM message using v5 instructions and submit it:
    ...
    ![](/polkadot-mkdocs/images/parachains/runtime-maintenance/coretime-renewal/coretime-renewal-6.webp)
...
![](/polkadot-mkdocs/images/parachains/runtime-maintenance/coretime-renewal/coretime-renewal-7.webp)
...
-   <span class="badge guide">Guide</span> __Unlock Your Parachain__
    ...
    [:octicons-arrow-right-24: Get Started](/polkadot-mkdocs/parachains/runtime-maintenance/unlock-parachains/)
...
- Resolved Markdown: https://docs.polkadot.com/parachains/customize-runtime/pallet-development/create-a-pallet.md
...
- Word Count: 3088; Token Estimate: 6102
- Last Updated: 2026-04-15T03:51:44+00:00
- Version Hash: sha256:1a75b3ecd6da276bfb147b94d56c451d84abdb21b35fdb7d5c4f1c742c97432a
...
- [Polkadot SDK dependencies installed](/polkadot-mkdocs/parachains/install-polkadot-sdk/).
- A [Polkadot SDK Parchain Template](/polkadot-mkdocs/parachains/launch-a-parachain/set-up-the-parachain-template/) set up locally.
- Basic familiarity with [FRAME concepts](/polkadot-mkdocs/parachains/customize-runtime/).
...
![](/polkadot-mkdocs/images/parachains/customize-runtime/pallet-development/create-a-pallet/create-a-pallet-01.webp)
...
-   <span class="badge guide">Guide</span> __Mock Your Runtime__
    ...
    [:octicons-arrow-right-24: Continue](/polkadot-mkdocs/parachains/customize-runtime/pallet-development/mock-runtime/)
...
- Resolved Markdown: https://docs.polkadot.com/parachains/launch-a-parachain/deploy-to-polkadot.md
...
1. Open the [Polkadot.js Apps: Paseo](https://polkadot.js.org/apps/?rpc=wss://paseo.dotters.network#/explorer) interface and connect to the Polkadot TestNet (Paseo).
    ...
    ![](/polkadot-mkdocs/images/parachains/launch-a-parachain/deploy-to-polkadot/deploy-to-polkadot-1.webp)
...
2. Navigate to the **Accounts** section:
    ...
    ![](/polkadot-mkdocs/images/parachains/launch-a-parachain/deploy-to-polkadot/deploy-to-polkadot-2.webp)

3. Copy the address of the account you want to use for the parachain deployment.

    ![](/polkadot-mkdocs/images/parachains/launch-a-parachain/deploy-to-polkadot/deploy-to-polkadot-3.webp)
...
4. Visit the [Polkadot Faucet](https://faucet.polkadot.io/?parachain=0) and paste the copied address in the input field. Ensure that the network is set to Paseo and click on the **Get some PASs** button.
    ...
    ![](/polkadot-mkdocs/images/parachains/launch-a-parachain/deploy-to-polkadot/deploy-to-polkadot-4.webp)
...
1. Navigate to the **Parachains** section:
    ...
    ![](/polkadot-mkdocs/images/parachains/launch-a-parachain/deploy-to-polkadot/deploy-to-polkadot-5.webp)
...
2. Register a ParaId:
    ...
    ![](/polkadot-mkdocs/images/parachains/launch-a-parachain/deploy-to-polkadot/deploy-to-polkadot-6.webp)

3. Review the transaction and click on the **+ Submit** button.

    ![](/polkadot-mkdocs/images/parachains/launch-a-parachain/deploy-to-polkadot/deploy-to-polkadot-7.webp)
...
4. After submitting the transaction, you can navigate to the **Explorer** tab and check the list of recent events for successful `registrar.Reserved`.
    ...
    ![](/polkadot-mkdocs/images/parachains/launch-a-parachain/deploy-to-polkadot/deploy-to-polkadot-8.webp)
...
Polkadot SDK-based parachains are defined by a file called the [chain specification](/polkadot-mkdocs/reference/glossary/#chain-specification), or chain spec for short. There are two types of chain spec files:
...
2. You should see fields to place your runtime Wasm and genesis state respectively, along with the parachain ID. Select your parachain ID, and upload `para-wasm` in the **code** field and `para-state` in the **initial state** field.
    ...
    ![](/polkadot-mkdocs/images/parachains/launch-a-parachain/deploy-to-polkadot/deploy-to-polkadot-9.webp)
...
3. Confirm your details and click the **+ Submit** button, where there should be a new Parathread with your parachain ID and an active **Deregister** button.
    ...
    ![](/polkadot-mkdocs/images/parachains/launch-a-parachain/deploy-to-polkadot/deploy-to-polkadot-10.webp)
...
- Resolved Markdown: https://docs.polkadot.com/parachains/customize-runtime/pallet-development/mock-runtime.md
...
- Word Count: 1361; Token Estimate: 2488
- Last Updated: 2026-04-15T03:51:44+00:00
- Version Hash: sha256:a0e8ff7eec0dde5b52306e37b4669e759c29db616d88ae978cefac78a2d284dc
...
In this guide, you'll learn how to create a mock runtime for the custom counter pallet built in the [Make a Custom Pallet](/polkadot-mkdocs/parachains/customize-runtime/pallet-development/create-a-pallet/) guide. This mock runtime will enable you to write comprehensive unit tests that verify:
...
-   <span class="badge guide">Guide</span> __Pallet Unit Testing__
    ...
    [:octicons-arrow-right-24: Continue](/polkadot-mkdocs/parachains/customize-runtime/pallet-development/pallet-testing/)
...
- Resolved Markdown: https://docs.polkadot.com/parachains/launch-a-parachain/obtain-coretime.md
...
If you haven't completed these prerequisites, start by referring to the [Deploy on Polkadot](/polkadot-mkdocs/parachains/launch-a-parachain/deploy-to-polkadot/) tutorial.
...
![Placing an on-demand order for coretime](/polkadot-mkdocs/images/parachains/launch-a-parachain/obtain-coretime/obtain-coretime-01.webp)
...
![RegionX home page with Wallet connected](/polkadot-mkdocs/images/parachains/launch-a-parachain/obtain-coretime/obtain-coretime-02.webp)
...
- Word Count: 869; Token Estimate: 1281
- Last Updated: 2026-04-15T03:51:44+00:00
- Version Hash: sha256:e7db57d71aa030706b453f9c6e3845c12be64db8d330b51ac58cd53eae66ac7c
...
Parachain consensus operates in tandem with the relay chain, leveraging [Nominated Proof of Stake (NPoS)](/polkadot-mkdocs/reference/glossary/#nominated-proof-of-stake-npos) for shared security. The process ensures parachain transactions achieve finality through the following steps:
...
-   <span class="badge learn">Learn</span> __Elastic Scaling__
    ...
    [:octicons-arrow-right-24: Elastic Scaling](/polkadot-mkdocs/reference/parachains/consensus/elastic-scaling/)
...
-   <span class="badge learn">Learn</span> __Asynchronous Backing__
    ...
    [:octicons-arrow-right-24: Asynchronous Backing](/polkadot-mkdocs/reference/parachains/consensus/async-backing/)
...
- Resolved Markdown: https://docs.polkadot.com/parachains/runtime-maintenance/runtime-upgrades.md
- Canonical (HTML): https://docs.polkadot.com/parachains/runtime-maintenance/runtime-upgrades/
- Summary: Learn how to safely perform runtime upgrades for your Polkadot SDK-based blockchain, including step-by-step instructions.
- Word Count: 1364; Token Estimate: 2361
- Last Updated: 2026-04-15T03:51:44+00:00
- Version Hash: sha256:45c1faa840c733e2b917f085a4781c4bf52df4d2001fddab97d440a0da5e99b2
...
- Resolved Markdown: https://docs.polkadot.com/parachains/runtime-maintenance/storage-migrations.md
...
- Word Count: 2267; Token Estimate: 3814
- Last Updated: 2026-04-15T03:51:44+00:00
- Version Hash: sha256:a7e6fcf310abff7e9d2ecb655cf144a609d9c6aed31bfddae57e4f32c4993ee8
...
For a complete implementation example of multi-block migrations, refer to the [official example](https://github.com/paritytech/polkadot-sdk/tree/polkadot-stable2512-3/substrate/frame/examples/multi-block-migrations) in the Polkadot SDK.
...
- Resolved Markdown: https://docs.polkadot.com/parachains/customize-runtime/pallet-development/pallet-testing.md
...
- Word Count: 1759; Token Estimate: 3672
- Last Updated: 2026-04-15T03:51:44+00:00
- Version Hash: sha256:dbec3874bb8c0f2187398b7d0db09c4c0f96ad3fc26ff969ea6ad73e5cee737f
...
- Resolved Markdown: https://docs.polkadot.com/parachains/runtime-maintenance/unlock-parachains.md
...
- Word Count: 1276; Token Estimate: 2014
- Last Updated: 2026-04-15T03:51:44+00:00
- Version Hash: sha256:5de8b665fa7927c6bb56afeda990e6a85fc9fd17470197deff2b78d129941c10
...
This document guides you through checking a parachain's lock status and safely executing the unlock procedure from a parachain using [XCM (Cross-Consensus Messaging)](/polkadot-mkdocs/parachains/interoperability/get-started/).
...
2. Query the parachain locked status:
    ...
    ![](/polkadot-mkdocs/images/parachains/runtime-maintenance/unlock-parachains/unlock-parachain-1.webp)
...
2. Build the `registrar.removeLock` extrinsic:
    ...
    ![](/polkadot-mkdocs/images/parachains/runtime-maintenance/unlock-parachains/unlock-parachain-2.webp)
...
3. Determine the transaction weight required for executing the call. You can estimate this by executing the `transactionPaymentCallApi.queryCallInfo` runtime call with the encoded call data previously obtained:
    ...
    ![](/polkadot-mkdocs/images/parachains/runtime-maintenance/unlock-parachains/unlock-parachain-3.webp)
...
=== "Runtime API"
    ...
    ![](/polkadot-mkdocs/images/parachains/runtime-maintenance/unlock-parachains/unlock-parachain-7.webp)
...
2. Create a `sudo.sudo` extrinsic that executes `polkadotXcm.send`:
    ...
    ![](/polkadot-mkdocs/images/parachains/runtime-maintenance/unlock-parachains/unlock-parachain-4.webp)
...
3. Construct the XCM and submit it:
    ...
    ![](/polkadot-mkdocs/images/parachains/runtime-maintenance/unlock-parachains/unlock-parachain-5.webp)
...
![](/polkadot-mkdocs/images/parachains/runtime-maintenance/unlock-parachains/unlock-parachain-6.webp)
