...
- reference
word_count: 79544
token_estimate: 134957
page_count: 52
build_timestamp: '2026-04-16T19:42:11.755721+00:00'
version_hash: sha256:75a9dbeae88b0f42a8ba1303d9b814c824c5a176ea2f93d49a3f05008af0e5cb
---
...
- Resolved Markdown: https://docs.polkadot.com/node-infrastructure/run-a-validator/operational-tasks/general-management.md
...
- Word Count: 3967; Token Estimate: 6864
- Last Updated: 2026-04-15T03:51:44+00:00
- Version Hash: sha256:e698ff8924849b220d8b15c71dd225a4be13ae61b5ee655f3f89c849b2a1fdfb
...
![Grafana login screen](/polkadot-mkdocs/images/node-infrastructure/run-a-validator/operational-tasks/general-management/general-management-01.webp)
...
2. Select **Add data source** to define the data source.
    ...
    ![Select Prometheus](/polkadot-mkdocs/images/node-infrastructure/run-a-validator/operational-tasks/general-management/general-management-02.webp)

3. Select **Prometheus**.

    ![Save and test](/polkadot-mkdocs/images/node-infrastructure/run-a-validator/operational-tasks/general-management/general-management-03.webp)
...
4. Enter `http://localhost:9090` in the **URL** field and click **Save & Test**. If **"Data source is working"** appears, your connection is configured correctly.
    ...
    ![Import dashboard](/polkadot-mkdocs/images/node-infrastructure/run-a-validator/operational-tasks/general-management/general-management-04.webp)
...
6. Start your Polkadot node by running `./polkadot`. You should now be able to monitor node performance, block height, network traffic, and tasks tasks on the Grafana dashboard.
    ...
    ![Live dashboard](/polkadot-mkdocs/images/node-infrastructure/run-a-validator/operational-tasks/general-management/general-management-05.webp)
...
Though they don't transfer funds, session keys are essential for validators as they sign messages related to consensus and parachains. Securing session keys is crucial as allowing them to be exploited or used across multiple nodes can lead to a loss of staked funds via [slashing](/polkadot-mkdocs/node-infrastructure/run-a-validator/staking-mechanics/offenses-and-slashes/).
...
- Resolved Markdown: https://docs.polkadot.com/node-infrastructure.md
...
- Word Count: 547; Token Estimate: 856
- Last Updated: 2026-04-15T03:51:44+00:00
- Version Hash: sha256:f3d58e0c3fe7241ffcfb4529bc521ebbee8bcb8f7795236808d5640fff0a21d6
...
- **Participate in consensus**: Run [BABE](/polkadot-mkdocs/reference/polkadot-hub/consensus-and-security/pos-consensus/#block-production-babe) and [GRANDPA](/polkadot-mkdocs/reference/polkadot-hub/consensus-and-security/pos-consensus/#finality-gadget-grandpa) protocols.
...
-   **Run RPC Nodes**
    ...
    [:octicons-arrow-right-24: Run a Node](/polkadot-mkdocs/node-infrastructure/run-a-node/polkadot-hub-rpc/)
...
-   **Run a Collator**
    ...
    [:octicons-arrow-right-24: Run a Collator](/polkadot-mkdocs/node-infrastructure/run-a-collator/)
...
-   **Run a Validator**
    ...
    [:octicons-arrow-right-24: Run a Validator](/polkadot-mkdocs/node-infrastructure/run-a-validator/requirements/)
...
- Resolved Markdown: https://docs.polkadot.com/node-infrastructure/run-a-validator/staking-mechanics/offenses-and-slashes.md
...
- Word Count: 2108; Token Estimate: 3398
- Last Updated: 2026-04-15T03:51:44+00:00
- Version Hash: sha256:391295aad258212059eb8df7b90111e81da9aa7b454043e6b90cc85829743e94
...
See the next section to understand how slash amounts for equivocations are calculated. If you want to know more details about slashing, please look at the research page on [Slashing mechanisms](https://research.web3.foundation/Polkadot/security/slashing/amounts).
...
- Resolved Markdown: https://docs.polkadot.com/node-infrastructure/run-a-validator/operational-tasks/pause-validating.md
...
- Word Count: 673; Token Estimate: 846
- Last Updated: 2026-04-15T03:51:44+00:00
- Version Hash: sha256:1cb8c1953274c778df3ddc93e4ad3eddf19550a6aa150b2590d99110a9ad5357
...
- Resolved Markdown: https://docs.polkadot.com/node-infrastructure/run-a-validator/staking-mechanics/rewards.md
...
- Word Count: 1790; Token Estimate: 2635
- Last Updated: 2026-04-15T03:51:44+00:00
- Version Hash: sha256:7d1378430aa8573704ea1e455a8c3aa1c70f882c2c2bcd86105fde916a217334
...
- Issuing validity statements for [parachain blocks](/polkadot-mkdocs/reference/parachains/blocks-transactions-fees/blocks/).
...
!!! note
    As of the March 2026 runtime upgrade, a **minimum commission of 10%** is enforced on-chain for all Polkadot validators. Setting a commission rate below 10% is no longer possible on Polkadot MainNet. Validators that do not meet this requirement become permissionlessly chill-able. See [Minimum Commission](/polkadot-mkdocs/node-infrastructure/run-a-validator/requirements/#minimum-commission) for details.
...
- Resolved Markdown: https://docs.polkadot.com/node-infrastructure/run-a-collator.md
...
- Word Count: 2652; Token Estimate: 5050
- Last Updated: 2026-04-15T03:51:44+00:00
- Version Hash: sha256:45be70d99b3d19da8762202708143c87bd657caf381ab8a271484527178fd187
...
=== "Docker"
    ...
    2. Verify the installation:
        ...
        ```bash
        docker run --rm parity/polkadot-parachain:stable2512-3 --version
        ```
...
=== "systemd"
    ...
    1. Download the `polkadot-parachain` binary using the latest stable [Polkadot SDK release](https://github.com/paritytech/polkadot-sdk/releases):
        ...
        ```bash
        wget https://github.com/paritytech/polkadot-sdk/releases/download/polkadot-stable2512-3/polkadot-parachain
        ```
...
=== "Docker"
    ...
    2. Launch the collator using Docker:
        ...
        docker run -d --name polkadot-collator --restart unless-stopped \
          ...
          parity/polkadot-parachain:stable2512-3 \
          --collator \
...
1. Check the existing collators for your target parachain:
    ...
    ![](/polkadot-mkdocs/images/node-infrastructure/run-a-collator/run-a-collator-01.webp)
...
3. Once approved (or if using on-chain selection), follow these steps to register session keys using Polkadot.js Apps:
    ...
    ![](/polkadot-mkdocs/images/node-infrastructure/run-a-collator/run-a-collator-02.webp)
...
4. (Optional - primarily for non-system parachains) If the parachain uses on-chain bonding for collator selection, register as a candidate using Polkadot.js Apps:
    ...
    ![](/polkadot-mkdocs/images/node-infrastructure/run-a-collator/run-a-collator-03.webp)
...
- Resolved Markdown: https://docs.polkadot.com/node-infrastructure/run-a-node/parachain-rpc.md
...
- Word Count: 2047; Token Estimate: 4147
- Last Updated: 2026-04-15T03:51:44+00:00
- Version Hash: sha256:9ba3f70668c31ecff31a9a6e0cba25f186995318acd0158dced5d0d1bc72bba8
...
- Resolved Markdown: https://docs.polkadot.com/node-infrastructure/run-a-node/polkadot-hub-rpc.md
- Canonical (HTML): https://docs.polkadot.com/node-infrastructure/run-a-node/polkadot-hub-rpc/
- Summary: Learn how to set up and run an RPC node for Polkadot Hub with Polkadot SDK RPC endpoints and optional Ethereum JSON-RPC compatibility.
- Word Count: 2700; Token Estimate: 5446
- Last Updated: 2026-04-15T03:51:44+00:00
- Version Hash: sha256:fd4db2cc2b0d41672beb40c197b1b706c22bc63a4c75d729085715a50a019668

# Run an RPC Node for Polkadot Hub

## Introduction

[Polkadot Hub](/polkadot-mkdocs/reference/polkadot-hub/) is the gateway to the Polkadot network, providing access to core services such as asset management, governance, and cross-chain messaging. Running your own RPC node gives developers and applications direct access to these services while also supporting infrastructure tasks like block indexing and SDK tool compatibility.
...
To verify the Ethereum RPC adapter is working correctly, you can test standard Ethereum JSON-RPC methods like `eth_chainId`, `eth_blockNumber`, and `eth_getBlockByNumber`. For a complete list of supported methods and example queries, see the [JSON-RPC APIs](/polkadot-mkdocs/smart-contracts/for-eth-devs/json-rpc-apis/) reference.
...
- Resolved Markdown: https://docs.polkadot.com/node-infrastructure/run-a-node/relay-chain/bootnode.md
...
- Word Count: 645; Token Estimate: 1043
- Last Updated: 2026-04-15T03:51:44+00:00
- Version Hash: sha256:343a184ba5ec7ed345dc2c5abc2f079d80d6beec86d4ff2dfe3f688ab658608d
...
- Resolved Markdown: https://docs.polkadot.com/node-infrastructure/run-a-node/relay-chain/full-node.md
...
- Word Count: 2471; Token Estimate: 4166
- Last Updated: 2026-04-15T03:51:44+00:00
- Version Hash: sha256:6b4570276ed504f98da37ec5b3757f58e4c55136afa3dfd3ee5d7f613f79c3e3
...
- [Install the necessary dependencies for the Polkadot SDK](/polkadot-mkdocs/parachains/install-polkadot-sdk/).

!!! warning
    This setup is not recommended for validators. If you plan to run a validator, refer to the [Running a Validator](/polkadot-mkdocs/node-infrastructure/run-a-validator/onboarding-and-offboarding/set-up-validator/) guide for proper instructions.
...
- Resolved Markdown: https://docs.polkadot.com/node-infrastructure/run-a-validator/onboarding-and-offboarding/set-up-validator.md
...
- Word Count: 1654; Token Estimate: 2519
- Last Updated: 2026-04-15T03:51:44+00:00
- Version Hash: sha256:a167880cae725c4cec2b5f7da520bb9859c0707c5929f7b10297f84db904ca8b
...
- Read [Validator Requirements](/polkadot-mkdocs/node-infrastructure/run-a-validator/requirements/) and understand the recommended minimum skill level and hardware needs.
- Read [General Management](/polkadot-mkdocs/node-infrastructure/run-a-validator/operational-tasks/general-management/), [Upgrade Your Node](/polkadot-mkdocs/node-infrastructure/run-a-validator/operational-tasks/upgrade-your-node/), and [Pause Validating](/polkadot-mkdocs/node-infrastructure/run-a-validator/operational-tasks/pause-validating/) and understand the tasks required to keep your validator operational.
- Read [Rewards Payout](/polkadot-mkdocs/node-infrastructure/run-a-validator/staking-mechanics/rewards/) and understand how validator rewards are determined and paid out.
- Read [Offenses and Slashes](/polkadot-mkdocs/node-infrastructure/run-a-validator/staking-mechanics/offenses-and-slashes/) and understand how validator performance and security can affect tokens staked by you or your nominators.
...
=== "`polkadot`"
    ...
    ``` bash
    # Download the binary
    curl -LO https://github.com/paritytech/polkadot-sdk/releases/download/polkadot-stable2512-3/polkadot

    # Verify signature
    curl -LO https://github.com/paritytech/polkadot-sdk/releases/download/polkadot-stable2512-3/polkadot.asc
...
=== "`polkadot-prepare-worker`"
    ...
    ``` bash
    # Download the binary
    curl -LO https://github.com/paritytech/polkadot-sdk/releases/download/polkadot-stable2512-3/polkadot-prepare-worker

    # Verify signature
    curl -LO https://github.com/paritytech/polkadot-sdk/releases/download/polkadot-stable2512-3/polkadot-prepare-worker.asc
...
=== "`polkadot-execute-worker`"
    ...
    ``` bash
    # Download the binary
    curl -LO https://github.com/paritytech/polkadot-sdk/releases/download/polkadot-stable2512-3/polkadot-execute-worker

    # Verify signature
    curl -LO https://github.com/paritytech/polkadot-sdk/releases/download/polkadot-stable2512-3/polkadot-execute-worker.asc
...
You may build the binaries from source by following the instructions on the [Polkadot SDK repository](https://github.com/paritytech/polkadot-sdk/tree/polkadot-stable2512-3/polkadot#building).
...
- Resolved Markdown: https://docs.polkadot.com/node-infrastructure/run-a-node/relay-chain/secure-wss.md
...
- Word Count: 757; Token Estimate: 1233
- Last Updated: 2026-04-15T03:51:44+00:00
- Version Hash: sha256:c832867fb54ed6d366ab2732498201b69107bcbebe00e1697a3c5e961988639c
...
![A sync-in-progress chain connected to Polkadot.js UI](/polkadot-mkdocs/images/node-infrastructure/run-a-node/secure-wss/secure-wss-01.webp)
...
Page Title: Staking Operator Proxy on Polkadot

- Resolved Markdown: https://docs.polkadot.com/node-infrastructure/run-a-validator/operational-tasks/staking-operator-proxy.md
- Canonical (HTML): https://docs.polkadot.com/node-infrastructure/run-a-validator/operational-tasks/staking-operator-proxy/
- Summary: Learn how the Staking Operator proxy enables non-custodial validator operations by separating fund management from node operations on Polkadot.
- Word Count: 1491; Token Estimate: 2307
- Last Updated: 2026-04-15T03:51:44+00:00
- Version Hash: sha256:5b187115ff324e45ed6a2746cf3ebd87aa212ea4b7d8261e2a3317a60896365b
...
1. **Bond DOT**: The staker bonds the desired amount of DOT to the stash account. Refer to the [Start Validating](/polkadot-mkdocs/node-infrastructure/run-a-validator/onboarding-and-offboarding/start-validating/) guide for detailed instructions on bonding.
...
- **Set session keys**: Rotate or update session keys using `stakingRcClient.setKeys` on Polkadot Hub or `session.setKeys` on the relay chain. See [Key Management](/polkadot-mkdocs/node-infrastructure/run-a-validator/operational-tasks/general-management/#key-management) for best practices on managing session keys.
- **Update commission**: Adjust the validator's commission rate by calling `staking.validate` with a new commission value.
- **Deactivate the validator**: Temporarily pause validation by calling `staking.chill`. See [Pause Validating](/polkadot-mkdocs/node-infrastructure/run-a-validator/operational-tasks/pause-validating/) for more details on the chilling process.
...
For guidance on rotating session keys during node upgrades, see [Upgrade a Validator Node](/polkadot-mkdocs/node-infrastructure/run-a-validator/operational-tasks/upgrade-your-node/).
...
- **Slashing risk remains**: While the operator cannot steal funds, improper session key management (such as running duplicate keys across nodes) can still lead to [equivocation slashing](/polkadot-mkdocs/node-infrastructure/run-a-validator/staking-mechanics/offenses-and-slashes/). Stakers should verify that operators follow proper [key management practices](/polkadot-mkdocs/node-infrastructure/run-a-validator/operational-tasks/general-management/#key-management).
...
- Resolved Markdown: https://docs.polkadot.com/node-infrastructure/run-a-validator/onboarding-and-offboarding/start-validating.md
...
1. In Polkadot.js Apps, navigate to **Network** and select **Staking**:
    ...
    ![](/polkadot-mkdocs/images/node-infrastructure/run-a-validator/onboarding-and-offboarding/start-validating/start-validating-01.webp)

2. Open the **Accounts** tab and click on **+ Validator**:

    ![](/polkadot-mkdocs/images/node-infrastructure/run-a-validator/onboarding-and-offboarding/start-validating/start-validating-02.webp)

3. Set a bond amount in the **value bonded** field and then click **next**:

    ![](/polkadot-mkdocs/images/node-infrastructure/run-a-validator/onboarding-and-offboarding/start-validating/start-validating-03.webp)
...
4. Paste the session keys and proof from `author_rotateKeysWithOwner` (or use the keys from `author_rotateKeys` with `0x00` as the proof if runtime 2.2.0 is not yet live on your network), set the commission, allow or block new nominations, then click **Bond & Validate** to link your validator with its session keys.
    ...
    ![](/polkadot-mkdocs/images/node-infrastructure/run-a-validator/onboarding-and-offboarding/start-validating/start-validating-04.webp)
    ...
    !!! warning
        As of the March 2026 runtime upgrade, a **minimum commission of 10%** is required for all validators. Setting a commission rate below 10% will make your validator permissionlessly chill-able through the `staking.chillOther` extrinsic. See [Minimum Commission](/polkadot-mkdocs/node-infrastructure/run-a-validator/requirements/#minimum-commission) for details.

    ![](/polkadot-mkdocs/images/node-infrastructure/run-a-validator/onboarding-and-offboarding/start-validating/start-validating-05.webp)
...
![staking queue](/polkadot-mkdocs/images/node-infrastructure/run-a-validator/onboarding-and-offboarding/start-validating/start-validating-06.webp)
...
- Confirm your system meets the [requirements](/polkadot-mkdocs/node-infrastructure/run-a-validator/requirements/) for running a validator.
...
- Resolved Markdown: https://docs.polkadot.com/node-infrastructure/run-a-validator/onboarding-and-offboarding/stop-validating.md
...
- Word Count: 499; Token Estimate: 628
- Last Updated: 2026-04-15T03:51:44+00:00
- Version Hash: sha256:724116e0df162b6662a7e5454019d66a7fc24345d8b8cb4ddb8784e694412bad
...
Use the `staking.chill` extrinsic to initiate this. For more guidance on chilling your node, refer to the [Pause Validating](/polkadot-mkdocs/node-infrastructure/run-a-validator/operational-tasks/pause-validating/) guide. You may also claim any pending staking rewards at this point.
...
- Resolved Markdown: https://docs.polkadot.com/node-infrastructure/run-a-validator/operational-tasks/upgrade-your-node.md
...
- Word Count: 923; Token Estimate: 1322
- Last Updated: 2026-04-15T03:51:44+00:00
- Version Hash: sha256:b98a0638d344791f5d6a57c43d6c04dee208f60f3cf0233f8f2a259b8fca645d
...
- Resolved Markdown: https://docs.polkadot.com/node-infrastructure/run-a-validator/onboarding-and-offboarding/key-management.md
...
=== "Pre-2.2.0 (Legacy)"
    ...
    === "Polkadot.js Apps UI"
        ...
        2. Construct an `author_rotateKeys` RPC call and execute it:
            ...
            ![](/polkadot-mkdocs/images/node-infrastructure/run-a-validator/onboarding-and-offboarding/key-management/key-management-01.webp)
...
=== "Polkadot Hub (Recommended)"
    ...
    The recommended approach is to use the `stakingRcClient.set_keys` extrinsic on Polkadot Hub. This path is required for validators using pure proxy stash accounts or [Staking Operator proxies](/polkadot-mkdocs/node-infrastructure/run-a-validator/operational-tasks/staking-operator-proxy/).
    ...
    === "Runtime 2.2.0+"
        ...
        ![](/polkadot-mkdocs/images/node-infrastructure/run-a-validator/onboarding-and-offboarding/key-management/key-management-03.webp)
...
- Resolved Markdown: https://docs.polkadot.com/node-infrastructure/run-a-validator/requirements.md
...
- Word Count: 1183; Token Estimate: 1760
- Last Updated: 2026-04-15T03:51:44+00:00
- Version Hash: sha256:b85b1a9b5a1fc77390319fff4ecdfe49da02b384f1a60ce318c3b9c082f228e5
...
- **Security**: Ensure your setup follows best practices for securing your node. Refer to the [Secure Your Validator](/polkadot-mkdocs/node-infrastructure/run-a-validator/operational-tasks/general-management/#secure-your-validator) section to learn about important security measures.
- **Network choice**: Start with [Kusama](/polkadot-mkdocs/node-infrastructure/run-a-validator/onboarding-and-offboarding/set-up-validator/#run-a-kusama-validator) to gain experience. Look for "Adjustments for Kusama" throughout these guides for tips on adapting the provided instructions for the Kusama network.
...
For more details on how commission rates affect reward distribution between validators and nominators, see [Rewards Payout](/polkadot-mkdocs/node-infrastructure/run-a-validator/staking-mechanics/rewards/). For non-custodial validator operations where the operator manages commission, see [Staking Operator Proxy](/polkadot-mkdocs/node-infrastructure/run-a-validator/operational-tasks/staking-operator-proxy/).
