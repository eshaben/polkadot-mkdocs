const provider=window.ethereum;const supportedNetworks={polkadotTestNet:{name:'Polkadot Hub TestNet',chainId:'0x190f1b41',chainName:'Polkadot Hub TestNet',rpcUrls:['https://eth-rpc-testnet.polkadot.io/','https://services.polkadothub-rpc.com/testnet/'],blockExplorerUrls:['https://blockscout-testnet.polkadot.io/','https://polkadot.testnet.routescan.io/'],nativeCurrency:{name:'Paseo Token',symbol:'PAS',decimals:18,},},polkadot:{name:'Polkadot Hub',chainId:'0x190f1b43',chainName:'Polkadot Hub',rpcUrls:['https://eth-rpc.polkadot.io/','https://services.polkadothub-rpc.com/mainnet/'],blockExplorerUrls:['https://blockscout.polkadot.io/'],nativeCurrency:{name:'Polkadot Token',symbol:'DOT',decimals:18,},},kusama:{name:'Kusama Hub',chainId:'0x190f1b42',chainName:'Kusama Hub',rpcUrls:['https://eth-rpc-kusama.polkadot.io/'],blockExplorerUrls:['https://blockscout-kusama.polkadot.io/'],nativeCurrency:{name:'Kusama Token',symbol:'KSM',decimals:18,},}};const connectNetwork=async(network)=>{if(!provider){handleError('No Ethereum-compatible wallet found. Please install MetaMask.');return;}
